...
<body>
 	 ...
 	 */
 	 IDAO dbConnection=new DB_Connection();
 	 UserModel model=dbConnection.gettime(userId);
 	 %>
...
<center>
		...
		<div class="container">
			...
			<form action="Process/editparktiming" method="get">
				<div class="col-md-4"></div>
				<div class="col-md-4">
					<div class="form-group">
						<label for="id">ID:</label> <input type="text" value="<%= model.getIid() %>"
							class="form-control" placeholder="Enter Your Id"
							required="required" name="id">
					</div>

					<div class="form-group">
						<label for="days"> DAYS:</label> <input type="text" value="<%= model.getDays() %>"
							class="form-control" placeholder="Enter admission criteria"
							required="required" name="days">
					</div>
					<div class="form-group">
						<label for="hours"> OPERATIONAL_HOURS:</label> <input type="text" value="<%= model.getHours() %>"
							class="form-control" placeholder="Enter adult"
							required="required" name="hours">
					</div>
