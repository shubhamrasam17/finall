...
<body>
 	 ...
 	 */
 	 IDAO dbConnection=new DB_Connection();
 	 UserModel model=dbConnection.getRecordsById(userId);
 	 %>
		...
		<div class="container">
			...
			<form action="Process/edit" method="get">
				...
				<div class="col-md-4">
					...
					<div class="form-group">
						<label for="fname"> first NAME:</label> <input type="text" value="<%= model.getFname() %>"
							class="form-control" placeholder="Enter Your Name"
							required="required" name="fname">
					</div>
					<div class="form-group">
						<label for="lname"> last NAME:</label> <input type="text" value="<%= model.getLname() %>"
							class="form-control" placeholder="Enter Your Name"
					...
					<div class="form-group">
						<label for="uname"> user NAME:</label> <input type="text" value="<%= model.getUname() %>"
							class="form-control" placeholder="Enter Your Name"
